    ...
    return (
        <div className='about-me-part'>
            ...
            <div className='about-me-wrapper'>
                <Image src={TimeLine} alt={"Timeline"} className="about-me-bgimage" style={{ height: `${lineLength}px` }} />
                {
                    aboutMe.map(item => {
                        const className = `about-me-container ${width <= 568 ? 'right' : item.position} ${item.category}`
                        return (
