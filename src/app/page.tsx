...
const Page = () => {
  ...
  const imagesArray = [
    {
      imageUrl: "/legislator.png",
      alt: "Legislator Election Official Website",
    },
    {
  ...
  const handleOnScroll = (e: Event) => {
    ...
    if (
      ...
      currentPosition >= position.work &&
      currentPosition < position.personal &&
      ...
      currentPosition >= position.personal &&
      currentPosition < position.about &&
      ...
      <div className="full-wrapper" ref={workProjectElement}>
        ...
        <div className="experience-wrapper">
          <Article data={visaData} type="visa">
            <Image
              src={VISAImage}
              alt={"Article VISA Image"}
              priority
              className="article-image visa-image"
            />
          </Article>
          <Article data={asusData} type="asus">
            <Image
              src={AsusImage}
              alt={"Article Asus Image"}
              priority
              className="article-image asus-image"
            />
          </Article>
          <Article data={advantechData} type="advantech">
            <Image
              src={AdvantechImage}
              alt={"Article Advantech Image"}
              priority
              className="article-image advantech-image"
            />
          </Article>
          <Article data={creatopData} type="creatop">
            <Image
              ...
              alt={"Article Advantech Image"}
              priority
              className="article-image creatop-image"
            />
          </Article>
        </div>
      </div>
          ...
          {personalProjects.map((project, index) => {
            ...
            return (
              <Article data={project} type={project.type} key={project.name}>
                <Image
                  src={imagesArray[index].imageUrl}
